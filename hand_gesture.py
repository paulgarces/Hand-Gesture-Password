...
password_file = f"{username}_gesture_password.json" # creates a user specific and custom file for their password sequences based on their username e.g. paul_gestsure_password.json : each user gets their own
...
result_show = "Access Granted" if input_sequence == password_array else "Access Denied" # if the input sequence is equal to the password array, then it will print "Access Granted", if not, then it will print "Access Denied"
